...
some of the men I respect, like Warren Buffet, are investors. I concluded that I would try to learn more about the finance industry, but my heart has always in software development and building a
company.
...
in size and complexity, but I do write a lot of code.
...
is incomplete but has good momentum. My opinion is that it will become the foundation for building cross-platform applications. At present, companies often build completely separate applications for android, ios, the web 
and so on. Web assembly will allow developers to build a single application that runs on all platforms, through browsers. Some implications of this are:
- The old environment for developing websites will decline in popularity (it is slow and inefficient).
- Some other environments are going to fill the gap. 

I am betting on an environment called *.Net core* (the reasons why are outside the scope of this article). In anticipation of .Net core's rise, I am currently developing tools for .Net core. These tools do stuff like 
...
It will be about 2 years before web assembly is ready and integrated with .Net core. Regardless of whether or not I manage to monetize my tools, what I learn will prepare me for building products based on web assembly 
...
## Back-Up Plan
As I teen, my bet was that computing would be in demand in the coming decades. Computing provides tangible value to companies. For example, many companies have ventured online because it widens their 
customer base and provides greater convenience. This is in contrast to the biotech fad. That entire industry was propped up by government support rather than market forces. I was confident that I would be able to
...
who pay entry-level workers [6 figures](https://www.payscale.com/research/US/Job=Software_Engineer/Salary/d2f8987b/Google-Inc.-Entry-Level). While I do not have a degree, with my portfolio, I am confident that over a reasonable
...
I went on at least 6 courses of antibiotics over a year. This was a massive mistake. Antibiotics can mess up bacteria in the gut, which can lead to problems like excessive gas. I still remember the first time I woke up and 
...
malnutrition and sleep deprivation. I came close to death a number of times, waking up frozen, blind, and not breathing, I feared falling asleep. Sure enough, I eventually ended up in the hospital - my heart was failing.
